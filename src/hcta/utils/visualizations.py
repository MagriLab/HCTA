...
def plot_2d_v2(
    ...
    ax.set_title(title, fontsize=fontsize, pad=122)  # pad = 55,122,190
    ax.grid()
    ...
    if add_inset:
        inset_axes1 = ax.inset_axes([0.12, 0.68, 0.25, 0.3])
        ...
        inset_axes1.set_yticks([0])
        inset_axes1.set_yticklabels(["$0$"])
        inset_axes1.grid()
        inset_axes1.set_xlabel("$x$")
        inset_axes1.set_xlim(inset_x_lim)
        inset_axes1.set_ylim(inset_y_lim)

        inset_axes2 = ax.inset_axes([0.52, 0.68, 0.25, 0.3])
        # inset_axes1 = ax.inset_axes([0.5, 0.05, 0.45, 0.45])
        if axis == 0:
            if Z is not None:
                inset_axes2.scatter(
        ...
        inset_axes2.set_yticks([0])
        inset_axes2.set_yticklabels(["$0$"])
        inset_axes2.grid()
        inset_axes2.set_xlabel("$x$")
        inset_axes2.set_xlim([0.95, 1])
        inset_axes2.set_ylim(inset_y_lim)
    return ax
